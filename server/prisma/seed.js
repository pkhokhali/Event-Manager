...
const shared_1 = require("@event-manager/shared");
const prisma = new client_1.PrismaClient();
async function main() {
    console.log('Seeding database...');
    for (const cat of shared_1.CATEGORY_SEED) {
    ...
    const vendors = [
        {
            ...
            nameNe: 'हिमालयन खाना',
            category: client_1.VendorCategoryType.CATERING,
            city: 'Kathmandu',
            phone: '+9779800000001',
            rating: 4.5,
            priceMin: 50000,
        ...
        },
        {
            ...
            category: client_1.VendorCategoryType.PHOTOGRAPHY,
            city: 'Pokhara',
            phone: '+9779800000002',
            rating: 4.8,
            priceMin: 25000,
        ...
        },
        {
            ...
            nameNe: 'मण्डला सजावट',
            category: client_1.VendorCategoryType.DECORATOR,
            city: 'Kathmandu',
            phone: '+9779800000003',
            rating: 4.3,
            priceMin: 30000,
        ...
        },
        {
            ...
            category: client_1.VendorCategoryType.PANDIT,
            city: 'Kathmandu',
            phone: '+9779800000004',
            rating: 4.9,
            priceMin: 5000,
